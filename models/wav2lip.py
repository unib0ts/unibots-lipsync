...
class Wav2Lip(nn.Module):
    def __init__(self):
        ...
        self.face_decoder_blocks = nn.ModuleList([
            ...
            Conv2d(1024, 1024, kernel_size=3, stride=1, padding=1, residual=True),
            Conv2d(1024, 1024, kernel_size=3, stride=1, padding=1, residual=True),), # 6, 6
            ...
            Conv2d(768, 768, kernel_size=3, stride=1, padding=1, residual=True),), # 12, 12

            nn.Sequential(Conv2dTranspose(1024, 384, kernel_size=3, stride=2, padding=1, output_padding=1),
