...
class Wav2Lip(nn.Module):
    def __init__(self):
        ...
        self.face_encoder_blocks = nn.ModuleList([
            ...
            nn.Sequential(Conv2d(16, 32, kernel_size=7, stride=1, padding=3), # 96,96
        ...
        self.face_decoder_blocks = nn.ModuleList([
            ...
            Conv2d(32, 32, kernel_size=3, stride=1, padding=1, residual=True),
            Conv2d(32, 32, kernel_size=3, stride=1, padding=1, residual=True),), # 192, 192
...
class Wav2Lip_disc_qual(nn.Module):
    def __init__(self):
        ...
        self.face_encoder_blocks = nn.ModuleList([
            nn.Sequential(nonorm_Conv2d(6, 32, kernel_size=7, stride=1, padding=3)), #96, 192

            nn.Sequential(nonorm_Conv2d(32, 64, kernel_size=7, stride=1, padding=3), # 96,96
            nonorm_Conv2d(64, 64, kernel_size=5, stride=1, padding=2)), 

            nn.Sequential(nonorm_Conv2d(64, 128, kernel_size=5, stride=(1, 2), padding=2), # 48,48
            nonorm_Conv2d(128, 128, kernel_size=5, stride=1, padding=2)),

            nn.Sequential(nonorm_Conv2d(128, 256, kernel_size=5, stride=2, padding=2),    # 24,24
            nonorm_Conv2d(256, 256, kernel_size=5, stride=1, padding=2)),

            nn.Sequential(nonorm_Conv2d(256, 512, kernel_size=5, stride=2, padding=2),   # 12,12
            nonorm_Conv2d(512, 512, kernel_size=5, stride=1, padding=2)),

            nn.Sequential(nonorm_Conv2d(512, 1024, kernel_size=3, stride=2, padding=1),       # 6,6
            nonorm_Conv2d(1024, 1024, kernel_size=3, stride=1, padding=1)),

            nn.Sequential(nonorm_Conv2d(1024, 1024, kernel_size=3, stride=2, padding=1),     # 3,3
            nonorm_Conv2d(1024, 1024, kernel_size=3, stride=1, padding=1),),
            
            nn.Sequential(nonorm_Conv2d(1024, 1024, kernel_size=3, stride=1, padding=0),     # 1, 1
            nonorm_Conv2d(1024, 1024, kernel_size=1, stride=1, padding=0)),])

        self.binary_pred = nn.Sequential(nn.Conv2d(1024, 1, kernel_size=1, stride=1, padding=0), nn.Sigmoid())
        self.label_noise = .0
